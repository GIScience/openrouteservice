 ...
 * @author Peter Karich
 */
public class Hike2FlagEncoder extends FootFlagEncoder
{
    /**
     * Should be only instantiated via EncodingManager
     */
    public Hike2FlagEncoder()
    {
        this(4, 1);
    }

    public Hike2FlagEncoder( PMap properties )
    {
    ...
    public Hike2FlagEncoder( String propertiesStr )
    {
        this(new PMap(propertiesStr));
    }

    public Hike2FlagEncoder( int speedBits, double speedFactor )
    {

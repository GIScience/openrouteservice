...
public abstract class HeavyVehicleEdgeFilter implements DestinationDependentEdgeFilter {
	...
	public HeavyVehicleEdgeFilter(FlagEncoder encoder, int vehicleType, boolean hasHazmat, float[] restrictionValues,
			Integer[] indexValues, GraphStorage graphStorage) {
		this(encoder, true, true, vehicleType, hasHazmat, restrictionValues, indexValues, graphStorage);
	}

	public HeavyVehicleEdgeFilter(FlagEncoder encoder, int vehicleType, boolean hasHazmat, GraphStorage graphStorage) {
		this(encoder, true, true, vehicleType, hasHazmat, null, null, graphStorage);
	}
	 ...
	 * vehicle.
	 */
	public HeavyVehicleEdgeFilter(FlagEncoder encoder, boolean in, boolean out, int vehicleType, boolean hasHazmat,
			float[] restrictionValues, Integer[] indexValues, GraphStorage graphStorage) {

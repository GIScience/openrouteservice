...
public class AvoidAreasEdgeFilter implements EdgeFilter {
	 ...
	 */
	public AvoidAreasEdgeFilter(FlagEncoder encoder, ArrayList<Polygon> polys)
	{
		this(encoder, true, true, polys);
	}

	public AvoidAreasEdgeFilter(FlagEncoder encoder, boolean in, boolean out, ArrayList<Polygon> polys)
	{

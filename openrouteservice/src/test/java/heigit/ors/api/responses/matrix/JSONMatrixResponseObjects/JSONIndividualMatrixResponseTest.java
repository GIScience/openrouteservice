...
public class JSONIndividualMatrixResponseTest {
    ...
    private JSONIndividualMatrixResponse weightsMatrixResponse;
    ...
    public void setUp() throws StatusCodeException {
        ...
        weightsMatrixResponse = new JSONIndividualMatrixResponse(matrixResult, matrixWeightsRequests.get(0));
    ...
    public void getDistances() {
        ...
        Assert.assertNull(weightsMatrixResponse.getDistances());
    }
    ...
    public void getWeights() {
        Assert.assertEquals(2, weightsMatrixResponse.getWeights().length);
        Assert.assertArrayEquals(new Double[]{0.0, 1.0}, weightsMatrixResponse.getWeights());
        Assert.assertNull(durationsMatrixResponse.getWeights());
        Assert.assertNull(distancesMatrixResponse.getWeights());
    }

    @Test
    public void setWeights() {
        weightsMatrixResponse.setWeights(new Double[]{1.0, 2.0, 3.0});
        Assert.assertEquals(3, weightsMatrixResponse.getWeights().length);
        Assert.assertArrayEquals(new Double[]{1.0, 2.0, 3.0}, weightsMatrixResponse.getWeights());
        Assert.assertNull(durationsMatrixResponse.getWeights());
        Assert.assertNull(distancesMatrixResponse.getWeights());
    }
    ...
    public void getDurations() {
        ...
        Assert.assertNull(weightsMatrixResponse.getDurations());
    }
    ...
    public void getDestinations() {
        ...
        Assert.assertEquals(1, weightsMatrixResponse.getDestinations().size());
        Assert.assertArrayEquals(new Double[]{8.681495, 49.41461}, weightsMatrixResponse.getDestinations().get(0).getLocation());
    }
    ...
    public void setDestinations() {
        ...
        weightsMatrixResponse.setDestinations(json2DDestinations);
        ...
        Assert.assertEquals(1, weightsMatrixResponse.getDestinations().size());
        Assert.assertArrayEquals(new Double[]{9.681495, 50.41461}, weightsMatrixResponse.getDestinations().get(0).getLocation());
    ...
    public void getSources() {
        ...
        Assert.assertEquals(1, weightsMatrixResponse.getSources().size());
        Assert.assertArrayEquals(new Double[]{8.681495, 49.41461}, weightsMatrixResponse.getSources().get(0).getLocation());
    }
    ...
    public void setSources() {
        ...
        weightsMatrixResponse.setSources(json2DSources);
        ...
        Assert.assertEquals(1, weightsMatrixResponse.getSources().size());
        Assert.assertArrayEquals(new Double[]{9.681495, 50.41461}, weightsMatrixResponse.getSources().get(0).getLocation());

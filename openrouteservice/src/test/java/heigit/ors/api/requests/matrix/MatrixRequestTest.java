...
public class MatrixRequestTest {
    ...
    public void getMetricsTest() throws ParameterValueException {
        ...
        matrixLocationsRequest = new MatrixRequest(bareCoordinates);
        matrixLocationsListRequest = new MatrixRequest(listOfBareCoordinatesList);
        Assert.assertArrayEquals(new String[]{"duration"}, bareMatrixRequest.getMetrics());
        Assert.assertArrayEquals(new String[]{"duration"}, matrixLocationsRequest.getMetrics());
        Assert.assertArrayEquals(new String[]{"duration"}, matrixLocationsListRequest.getMetrics());
    }
    ...
    public void setMetricsTest() throws ParameterValueException {
        ...
        matrixLocationsRequest = new MatrixRequest(bareCoordinates);
        matrixLocationsListRequest = new MatrixRequest(listOfBareCoordinatesList);
        bareMatrixRequest.setMetrics(new String[]{"foo"});
        matrixLocationsRequest.setMetrics(new String[]{"foo"});
        matrixLocationsListRequest.setMetrics(new String[]{"foo"});
        Assert.assertArrayEquals(new String[]{"foo"}, bareMatrixRequest.getMetrics());
        Assert.assertArrayEquals(new String[]{"foo"}, matrixLocationsRequest.getMetrics());
        Assert.assertArrayEquals(new String[]{"foo"}, matrixLocationsListRequest.getMetrics());
    }
    ...
    public void getUnitsTest() throws ParameterValueException {
        ...
        matrixLocationsRequest = new MatrixRequest(bareCoordinates);
        matrixLocationsListRequest = new MatrixRequest(listOfBareCoordinatesList);
        Assert.assertEquals("m", bareMatrixRequest.getUnits());
        Assert.assertEquals("m", matrixLocationsRequest.getUnits());
        Assert.assertEquals("m", matrixLocationsListRequest.getUnits());
    }
    ...
    public void setUnitsTest() throws ParameterValueException {
        ...
        matrixLocationsRequest = new MatrixRequest(bareCoordinates);
        matrixLocationsListRequest = new MatrixRequest(listOfBareCoordinatesList);
        bareMatrixRequest.setUnits("km");
        matrixLocationsRequest.setUnits("km");
        matrixLocationsListRequest.setUnits("km");
        Assert.assertEquals("km", bareMatrixRequest.getUnits());
        Assert.assertEquals("km", matrixLocationsRequest.getUnits());
        Assert.assertEquals("km", matrixLocationsListRequest.getUnits());
    }

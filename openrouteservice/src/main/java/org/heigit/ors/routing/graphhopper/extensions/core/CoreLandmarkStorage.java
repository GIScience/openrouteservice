...
public class CoreLandmarkStorage extends LandmarkStorage  {
    ...
    protected static class CoreEdgeFilter implements CHEdgeFilter {
        ...
        public CoreEdgeFilter(RoutingCHGraph graph) {
            this.graph = graph;
            coreNodeLevel = graph.getNodes();
        }
...
//TODO: Adapt the rest of the original code
//
...
//
//    public CoreLandmarkStorageOld(Directory dir, GraphHopperStorage graph, Map<Integer, Integer> coreNodeIdMap, final Weighting weighting, LMEdgeFilterSequence landmarksFilter, int landmarks) {
//        this.graph = graph;
//        this.coreNodeIdMap = coreNodeIdMap;
...
//     */
//    public CoreLandmarkStorageOld setMaximumWeight(double maxWeight) {
//        if (maxWeight > 0) {
...
//     */
//    public CoreLandmarkStorageOld setLandmarkSuggestions(List<LandmarkSuggestion> landmarkSuggestions) {
...
//        private final CoreLandmarkStorageOld lms;
//
//        public CoreLandmarkExplorer(Graph g, CoreLandmarkStorageOld lms, Weighting weighting, TraversalMode tMode) {

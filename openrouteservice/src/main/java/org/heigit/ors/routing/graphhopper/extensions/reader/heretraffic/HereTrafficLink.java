...
public class HereTrafficLink {
    ...
    private HereTrafficLinkMetadata trafficLinkMetadata;
    ...
    public HereTrafficLink(int linkId, Geometry linkGeometry, Collection<Property> properties, DistanceCalcEarth distanceCalcEarth) throws InvalidObjectException {
        ...
        trafficLinkMetadata = new HereTrafficLinkMetadata(properties);
    ...
    public boolean isPotentialTrafficSegment() {
        ...
        return trafficLinkMetadata.functionalClass() != HereTrafficEnums.FunctionalClass.CLASS5;
    }

    public boolean isBothDirections() {
        return trafficLinkMetadata.getTravelDirection() == HereTrafficEnums.LinkTravelDirection.BOTH;
    }
    ...
    public boolean isOnlyFromDirection() {
        return trafficLinkMetadata.getTravelDirection() == HereTrafficEnums.LinkTravelDirection.FROM;
    }
}

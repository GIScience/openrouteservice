...
public class FileUtility {
	...
	public static Path getResourcesPath() {
		...
		String classesSubPath = "classes";
		String resourcesSubPath = "resources";
		if (classPath.contains(classesSubPath)) {
			String classesPath = classPath.substring(0, classPath.indexOf(classesSubPath) + classesSubPath.length());
			return Paths.get(classesPath, resourcesSubPath);
		} else {
			return Paths.get(classPath, resourcesSubPath);
		}
	}

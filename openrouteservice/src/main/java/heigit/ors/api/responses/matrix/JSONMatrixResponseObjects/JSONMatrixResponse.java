...
public class JSONMatrixResponse extends MatrixResponse {
    public JSONMatrixResponse(List<MatrixResult> matrixResults, List<MatrixRequest> matrixRequests, heigit.ors.api.requests.matrix.MatrixRequest originalRequest) {
        ...
        this.matrixResults.add(contructCombindedMatrixResponse(matrixResults, matrixRequests));
    }

    private JSONIndividualMatrixResponse contructCombindedMatrixResponse(List<MatrixResult> matrixResults, List<MatrixRequest> matrixRequests) {

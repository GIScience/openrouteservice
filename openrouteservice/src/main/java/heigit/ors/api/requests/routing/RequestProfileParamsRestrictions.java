...
public class RequestProfileParamsRestrictions {
    @ApiModelProperty(value = "Only for avoided hills or specified steepness_difficulty. Specifies the maximum route steepness in percent. Values range from 1 to 15. Routes with a higher gradient are avoided.[{profile=[bike-*,foot-*]}]",
            example = "5")
    ...
    @ApiModelProperty(value = "Length restriction in metres.[{profile=[hgv]}]", example = "8.4")
    @JsonProperty("length")
    private Float length;
    private boolean hasLength = false;

    @ApiModelProperty(value = "Width restriction in metres.[{profile=[hgv]}]", example = "5.6")
    @JsonProperty("width")
    private Float width;
    @JsonIgnore
    private boolean hasWidth = false;

    @ApiModelProperty(value = "Height restriction in metres.[{profile=[hgv]}]", example = "4.2")
    @JsonProperty("height")
    ...
    @ApiModelProperty(value = "Weight restriction in tons.[{profile=[hgv]}]", example = "40")
    @JsonProperty("weight")
    private Float weight;
    @JsonIgnore
    private boolean hasWeight = false;

    @ApiModelProperty(value = "Specifies whether to use appropriate routing for delivering hazardous goods and avoiding water protected areas. Default is false.[{profile=[hgv]}]")
    ...
    @ApiModelProperty(value = "Specifies the minimum surface type. Default is \"cobblestone:flattened\".[{profile=[wheelchair]}]", example = "asphalt")
    ...
    @ApiModelProperty(value = "Specifies the minimum grade of the route. Default is \"grade1\".[{profile=[wheelchair]}]", example = "grade2")
    @JsonProperty(value = "track_type", defaultValue = "grade1")
    private String trackType = "grade1";
    @JsonIgnore
    private boolean hasTrackType = false;

    @ApiModelProperty(value = "Specifies the minimum smoothness of the route. Default is \"good\".[{profile=[wheelchair]}]", example = "best")
    ...
    @ApiModelProperty(value = "Specifies the maximum height of the sloped curb in metres. Values are 0.03, 0.06(default), 0.1.[{profile=[wheelchair]}]", example = "0.03")
    ...
    @ApiModelProperty(value = "Specifies the maximum incline as a percentage. 3, 6(default), 10, 15.[{profile=[wheelchair]}]", example = "3")
    @JsonProperty(value = "maximum_incline", defaultValue = "6")
    private Integer maxIncline = 6;
    @JsonIgnore
    private boolean hasMaxIncline = false;

    @ApiModelProperty(value = "Specifies the minimum width of the footway in metres.[{profile=[wheelchair]}]", example = "2.5")
    @JsonProperty(value = "minimum_width")
    private Float minWidth;
    @JsonIgnore
    private boolean hasMinWidth = false;

    @ApiModelProperty(value = "Specifies the maximum trail difficulty.[{profile=[wheelchair]}]", example = "3")

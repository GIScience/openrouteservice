...
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.BoundsType;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.CopyrightType;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.EmailType;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.Gpx;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.GpxExtensions;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.LinkType;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.MetadataType;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.PersonType;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.RteType;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.RteTypeExtensions;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.WptType;
import heigit.ors.util.GlobalExportWriter.gpxUtil.beans.WptTypeExtensions;

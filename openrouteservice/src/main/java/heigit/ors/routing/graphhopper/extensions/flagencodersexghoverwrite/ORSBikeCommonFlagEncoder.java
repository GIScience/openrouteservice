 ...
 * @author ratrun
 */
abstract public class ORSBikeCommonFlagEncoder extends AbstractFlagEncoder {
    /**
    ...
    protected ORSBikeCommonFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts, boolean considerElevation) {
        // MARQ24 MOD END

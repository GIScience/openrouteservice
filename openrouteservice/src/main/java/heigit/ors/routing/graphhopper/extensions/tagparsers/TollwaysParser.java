 ...
 */
package heigit.ors.routing.graphhopper.extensions.tagparsers;
...
import heigit.ors.routing.graphhopper.extensions.storages.builders.AbstractGraphStorageBuilder;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class TollwaysParser implements TagParser
{
	private final IntEncodedvalue ev;
	private int _tollways;
	private List<String> _tollTags = new ArrayList<String>(7);

	public TollwaysParser()
	{
		this.ev = new IntEncodedValue(TagParserFactory.TOLLWAYS, 16);

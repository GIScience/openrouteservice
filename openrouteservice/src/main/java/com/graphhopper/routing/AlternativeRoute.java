...
public class AlternativeRoute implements RoutingAlgorithm {
    ...
    public List<AlternativeInfo> calcAlternatives(int from, int to) {
        // MARQ24 MOD START
        //AlternativeBidirSearch altBidirDijktra = new AlternativeBidirSearch(graph, weighting, traversalMode, maxExplorationFactor * 2);
        AlternativeBidirSearch altBidirDijktra = new AlternativeBidirSearch(graph, weighting, traversalMode, maxExplorationFactor * 2, this.maxSpeed);
        // MARQ24 MOD END
        ...
        // MARQ24 MOD START
        //List<AlternativeInfo> alternatives = altBidirDijktra.calcAlternatives(maxPaths, maxWeightFactor, 7, maxShareFactor, 0.8, minPlateauFactor, -0.2);
        List<AlternativeInfo> alternatives = altBidirDijktra.calcAlternatives(maxPaths, maxWeightFactor, 7, maxShareFactor, 0.8, minPlateauFactor, -0.2, maxSpeed);
        // MARQ24 MOD END
        return alternatives;
    }
    ...
    public static class AlternativeBidirSearch extends AStarBidirection {
        ...
        // MARQ24 MOD START
        public AlternativeBidirSearch(Graph graph, Weighting weighting, TraversalMode tMode, double explorationFactor, double maxSpeed) {
        ...
        public List<AlternativeInfo> calcAlternatives(final int maxPaths, double maxWeightFactor,
                                                      final double weightInfluence, final double maxShareFactor,
                                                      final double shareInfluence, final double minPlateauFactor,
                                                      final double plateauInfluence, final double maxSpeed) {
        // MARQ24 MOD END

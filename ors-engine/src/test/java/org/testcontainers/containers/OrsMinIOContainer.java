 ...
 * </ul>
 */
public class OrsMinIOContainer extends GenericContainer<MinIOContainer> {
     ...
     */
    public OrsMinIOContainer(final String dockerImageName) {
     ...
     * @param dockerImageName the full image name to use
     */
    public OrsMinIOContainer(final DockerImageName dockerImageName) {
...
//        dockerImageName.assertCompatibleWith(DEFAULT_IMAGE_NAME);
     ...
     * @return this
     */
    public OrsMinIOContainer withUserName(String userName) {
     ...
     * @return this
     */
    public OrsMinIOContainer withPassword(String password) {

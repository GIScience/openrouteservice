...
public class WheelchairKerbHeightParser extends WheelchairBaseParser<IntEncodedValue> {
    ...
    public IntsRef handleWayTags(IntsRef edgeFlags, ReaderWay way, boolean ferry, IntsRef relationFlags) {
        ...
        Map<Integer, Map<String, String>> nodeTags = way.getTag("ors:node_tags", new HashMap<Integer, Map<String, String>>());
     ...
     */
    int getKerbHeightForEdge(ReaderWay way, Map<Integer, Map<String, String>> nodeTags) {
        int kerbHeight = -1;
     ...
     */
    int getKerbHeightFromNodeTags(Map<Integer, Map<String, String>> nodeTags) {

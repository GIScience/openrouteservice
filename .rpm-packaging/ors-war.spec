...
%install
mkdir -p "${RPM_BUILD_ROOT}/opt/openrouteservice/.war-files/"
cp -f ors.war "${RPM_BUILD_ROOT}/opt/openrouteservice/.war-files/%{ors_version}_ors.war"
...
mkdir -p /opt/openrouteservice/{graphs, logs, conf, .war-files}

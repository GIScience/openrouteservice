...
do
  ...
  for i in $(seq 1 $max_iteration); do
    ...
    docker run -it --user $UID -d -p 8082:8082 --env-file ./config.env -v ./karlsruhe-regbez-latest.osm.pbf:/home/ors/files/osm.pbf:ro --name ors-instance openrouteservice/openrouteservice:v8.1.0

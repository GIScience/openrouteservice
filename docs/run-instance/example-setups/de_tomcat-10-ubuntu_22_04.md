...
Dieses Tutorial zeigt dir, wie du openrouteservice mit Java 17, Tomcat 10 und ORS v9 einrichtest.
...
Um openrouteservice v9 mit Tomcat 10 einzurichten, benötigst du zunächst das entsprechende WAR-File. Besuche
...
```shell
# Lade das neueste openrouteservice WAR-File herunter, z. B. für v9.0.0

...
* `example-heidelberg.osm.pbf`: The initial sample OSM data used to run the container in its initial setup. Normally, you will remove this file or add another OSM file to the same directory and adapt your config to use your file.
...
ors-app  | 2024-03-12T08:13:19.142118351Z ⓘ Default to example osm source file: "/home/ors/files/example-heidelberg.osm.pbf"
...
ors-app  | 2024-03-12T08:13:19.199741022Z ✓ The file /home/ors/files/example-heidelberg.osm.pbf is up to date
...
* The evaluated OSM file: `====> Initializing profiles from '/home/ors/files/example-heidelberg.osm.pbf'` (also internal path)

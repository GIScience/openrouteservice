...
profiles. See [profiles](./profiles/index.md) for more information.
...
| config_output      | string  | If set, the default configuration values are written to a file named as the value. The application will shut down immediately afterwards without starting up any services. See [configuration](../how-to-configure.md#configuration-defaults-output) page for details.                               |               |
...
| profile_default    | object  | Described in [profiles](./profiles/index.md)                                                                                                                                                                                                                                                         |               |
| profiles           | object  | Described in [profiles](./profiles/index.md)                                                                                                                                                                                                                                                         |               |

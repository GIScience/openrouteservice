# Setup ORS v8 with Tomcat 10 on Ubuntu 22.04
...
Openrouteservice v8 requires Java 17 or higher to run.
...
```shell
# Download the latest openrouteservice WAR-File for v8.2.0.

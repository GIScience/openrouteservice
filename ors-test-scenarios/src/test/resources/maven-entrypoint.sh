...
exec mvn spring-boot:run -o -pl '!:ors-test-scenarios,!:ors-report-aggregation,!:ors-engine' -DskipTests -Dmaven.test.skip=true -Dspring-boot.run.jvmArguments="${JVM_ARGS}" "$@"

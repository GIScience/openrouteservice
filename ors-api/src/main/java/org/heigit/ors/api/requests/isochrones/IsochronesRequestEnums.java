...
public class IsochronesRequestEnums {
    ...
    public enum Attributes {
        ...
        public static Attributes forValue(String v) throws ParameterValueException {
            ...
            throw new ParameterValueException(IsochronesErrorCodes.INVALID_PARAMETER_VALUE, "attributes", v);
        }
    ...
    public enum RangeType {
        ...
        public static RangeType forValue(String v) throws ParameterValueException {
            ...
            throw new ParameterValueException(IsochronesErrorCodes.INVALID_PARAMETER_VALUE, "range_type", v);
        }
    ...
    public enum LocationType {
        ...
        public static LocationType forValue(String v) throws ParameterValueException {
            ...
            throw new ParameterValueException(IsochronesErrorCodes.INVALID_PARAMETER_VALUE, "location_type", v);
        }
    ...
    public enum CalculationMethod {
        ...
        public static CalculationMethod forValue(String v) throws ParameterValueException {
            ...
            throw new ParameterValueException(IsochronesErrorCodes.INVALID_PARAMETER_VALUE, "calc_method", v);
        }
    }

...
class ResultTest extends ServiceTest {
    ...
    void testLocationType() {
        ...
        given()
                ...
                .post(getEndPointPath() + "/{profile}/geojson")
                .then().log().ifValidationFails()
                .body("features[0].properties.area", is(closeTo(1549601.2f, 10000f)))
                .statusCode(200);
    }
    ...
    void testIsocalores() {
        ...
        // JSON request body: {"locations":[[8.684177,49.423034]],"range":[400],"attributes":["area"]}
        given()
                .config(JSON_CONFIG_DOUBLE_NUMBERS)
                .headers(CommonHeaders.geoJsonContent)
        ...
        // JSON request body: {"locations":[[8.684177,49.423034]],"range":[400],"attributes":["area"],"options":{"profile_params":{"weightings":{"csv_column":"less_than_0.5", "csv_factor":2}}}}
        given()
                .config(JSON_CONFIG_DOUBLE_NUMBERS)
                .headers(CommonHeaders.geoJsonContent)
                .pathParam("profile", getParameter("footProfile"))
        ...
        // JSON request body: {"locations":[[8.684177,49.423034]],"range":[400],"attributes":["area"],"options":{"profile_params":{"weightings":{"csv_column":"less_than_0.5", "csv_factor":5}}}}
        given()
                .config(JSON_CONFIG_DOUBLE_NUMBERS)
                .headers(CommonHeaders.geoJsonContent)
                .pathParam("profile", getParameter("footProfile"))
        ...
        // JSON request body: {"locations":[[8.684177,49.423034]],"range":[400],"attributes":["area"],"options":{"profile_params":{"weightings":{"csv_column":"greater_than_0.5", "csv_factor":2}}}}
        given()
                .config(JSON_CONFIG_DOUBLE_NUMBERS)
                .headers(CommonHeaders.geoJsonContent)
                .pathParam("profile", getParameter("footProfile"))
    ...
    void testIsocaloresDegreesC() {
        ...
        // JSON request body: {"locations":[[8.684177,49.423034]],"range":[400],"attributes":["area"],"options":{"profile_params":{"weightings":{"csv_column":"less_than_0.5", "csv_degree_c":20}}}}
        given()
                .config(JSON_CONFIG_DOUBLE_NUMBERS)
                .headers(CommonHeaders.geoJsonContent)
                .pathParam("profile", getParameter("footProfile"))
        ...
        // JSON request body: {"locations":[[8.684177,49.423034]],"range":[400],"attributes":["area"],"options":{"profile_params":{"weightings":{"csv_column":"less_than_0.5", "csv_degree_c":25}}}}
        given()
                .config(JSON_CONFIG_DOUBLE_NUMBERS)
                .headers(CommonHeaders.geoJsonContent)
                .pathParam("profile", getParameter("footProfile"))
        ...
        // JSON request body: {"locations":[[8.684177,49.423034]],"range":[400],"attributes":["area"],"options":{"profile_params":{"weightings":{"csv_column":"greater_than_0.5", "csv_degree_c":25}}}}
        given()
                .config(JSON_CONFIG_DOUBLE_NUMBERS)
                .headers(CommonHeaders.geoJsonContent)
                .pathParam("profile", getParameter("footProfile"))
        ...
        // JSON request body: {"locations":[[8.684177,49.423034]],"range":[400],"attributes":["area"],"options":{"profile_params":{"weightings":{"csv_column":"greater_than_0.5", "csv_degree_c":30}}}}
        given()
                .config(JSON_CONFIG_DOUBLE_NUMBERS)
                .headers(CommonHeaders.geoJsonContent)
                .pathParam("profile", getParameter("footProfile"))

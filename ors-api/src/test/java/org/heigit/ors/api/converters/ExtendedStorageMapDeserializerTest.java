...
class ExtendedStorageMapDeserializerTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "{\"WayCategory\":{}}, WayCategory, true",
            "{\"WayCategory\":{\"enabled\":false}}, WayCategory, false",
            "{\"HeavyVehicle\":{}}, HeavyVehicle, true",
            "{\"HeavyVehicle\":null}, HeavyVehicle, true",
            "{\"HeavyVehicle\":\"\"}, HeavyVehicle, true",
            "{\"HeavyVehicle\":\"null\"}, HeavyVehicle, true",
    })
    void testDeserializePath(String jsonInput, String expectedKey, boolean expectedEnabled) throws IOException {

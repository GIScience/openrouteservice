...
public class ResultTest extends ServiceTest {
    ...
    public void testCrossVirtualNode() {
        ...
        given()
                ...
                .body("durations[0][2]", is(closeTo(1626.6f, 1.0f)))
                .body("durations[0][3]", is(closeTo(1415.8f, 1.0f)))
                ...
                .body("durations[2][0]", is(closeTo(1599.3f, 1.0f)))
                ...
                .body("durations[3][0]", is(closeTo(1388.9f, 1.0f)))

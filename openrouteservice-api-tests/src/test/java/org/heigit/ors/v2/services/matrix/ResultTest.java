...
public class ResultTest extends ServiceTest {
    ...
    public void testCrossVirtualNode() {
        ...
        given()
                ...
                .body("durations[0][1]", is(closeTo(531.8f, 1.0f)))
                .body("durations[0][2]", is(closeTo(1610.7f, 1.0f)))
                .body("durations[0][3]", is(closeTo(1403.2f, 1.0f)))
                .body("durations[1][0]", is(closeTo(485.9f, 1.0f)))
                .body("durations[1][1]", is(closeTo(0.0f, 1.0f)))
                .body("durations[1][2]", is(closeTo(1203.2, 1.0f)))
                .body("durations[1][3]", is(closeTo(995.7f, 1.0f)))
                .body("durations[2][0]", is(closeTo(1583.3f, 1.0f)))
                .body("durations[2][1]", is(closeTo(1196.6f, 1.0f)))
                .body("durations[2][2]", is(closeTo(0.0f, 1.0f)))
                .body("durations[2][3]", is(closeTo(207.5f, 1.0f)))
                .body("durations[3][0]", is(closeTo(1375.9f, 1.0f)))
                .body("durations[3][1]", is(closeTo(989.2f, 1.0f)))
                .body("durations[3][2]", is(closeTo(207.5f, 1.0f)))

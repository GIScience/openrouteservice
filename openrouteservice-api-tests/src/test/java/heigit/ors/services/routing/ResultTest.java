...
public class ResultTest extends ServiceTest {
	...
	public void testAvoidTrailDifficulty() {
		...
		.body("any { it.key == 'routes' }", is(true))
		.body("routes[0].containsKey('extras')", is(true))
		.body("routes[0].segments[0].steps.size()", is(21))
		.body("routes[0].segments[0].distance", is(4332))
		.body("routes[0].segments[0].duration", is(1804.3f))
		.body("routes[0].extras.traildifficulty.values.size()", is(2))
		.body("routes[0].extras.traildifficulty.values[0][0]", is(0))
		.body("routes[0].extras.traildifficulty.values[0][1]", is(129))
		.body("routes[0].extras.traildifficulty.values[0][2]", is(0))
		.body("routes[0].extras.traildifficulty.values[1][0]", is(129))
		.body("routes[0].extras.traildifficulty.values[1][1]", is(161))

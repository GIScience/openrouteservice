...
public class ResultTest extends ServiceTest {
    ...
    public void testReachfactorAndArea() {
        ...
        given()
                ...
                //.body("features[0].properties.area", is(5433839.5f))
                .body("features[0].properties.area", is(both(greaterThan(5400000f)).and(lessThan(5430000f))))
                //.body("features[0].properties.reachfactor", is(0.1508f))
                .body("features[0].properties.reachfactor", is(0.056f))
                .statusCode(200);
    }
    ...
    public void testReachfactorAndAreaAreaUnitsKM() {
        ...
        given()
                ...
                .body("any { it.key == 'type' }", is(true))
                .body("any { it.key == 'features' }", is(true))
                .body("features[0].properties.area", is(both(greaterThan(5.4f)).and(lessThan(5.43f))))
                .body("features[0].properties.reachfactor", is(0.056f))
                .statusCode(200);
    }
    ...
    public void testReachfactorAndAreaAreaUnitsMI() {
        ...
        given()
                ...
                .body("any { it.key == 'type' }", is(true))
                .body("any { it.key == 'features' }", is(true))
                .body("features[0].properties.area", is(both(greaterThan(2.0f)).and(lessThan(2.1f))))
                .body("features[0].properties.reachfactor", is(0.056f))
                .statusCode(200);
    }
    ...
    public void testIntersections() {
        ...
        given()
                ...
                .body("features[0].properties.area", is(both(greaterThan(5428200f)).and(lessThan(5428300f))))

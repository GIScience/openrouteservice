...
public class ResultTest extends ServiceTest {
	...
	public void testPolygon() {
		...
		given()
				...
				.body("bbox", hasItems(8.663306f, 49.409462f, 8.695987f, 49.43984f))
	...
	public void testReachfactorAndArea() {
		...
		given()
				...
				.body("any { it.key == 'type' }", is(true))
				.body("any { it.key == 'features' }", is(true))
				.body("features[0].properties.area", is(1.4087912E7f))
				.body("features[0].properties.reachfactor", is(0.1453f))
				.statusCode(200);
	}
	...
	public void testIntersections() {
		...
		given()
				...
				.body("features[2].properties.area", is(5256049.5f))

...
public class ResultTest extends ServiceTest {
	...
	public void testPolygon() {
		...
		given()
				...
				.body("bbox", hasItems(8.665036f, 49.409863f, 8.695978f, 49.439163f))
	...
	public void testReachfactorAndArea() {
		...
		given()
				...
				.body("any { it.key == 'type' }", is(true))
				.body("any { it.key == 'features' }", is(true))
				.body("features[0].properties.area", is(1.2696907E7f))
	...
	public void testIntersections() {
		...
		given()
				...
				.body("features[2].properties.area", is(4807403.5f))

...
public class ResultTest extends ServiceTest {
	...
	public void testPolygon() {
		...
		given()
				...
				//.body("bbox", hasItems(8.664995f, 49.409695f, 8.695979f, 49.43919f))
	...
	public void testReachfactorAndArea() {
		...
		given()
				...
				//.body("features[0].properties.area", is(1.2938996E7f))
				.body("features[0].properties.reachfactor", is(0.1508f))
				//.body("features[0].properties.reachfactor", is(0.1334f))
				.statusCode(200);
	}
	...
	public void testIntersections() {
		...
		given()
				...
				//.body("features[2].geometry.coordinates[0].size()", is(27))
				...
				//.body("features[2].properties.area", is(5092562.5f))

...
public class ResultTest extends ServiceTest {
	...
	public void testPolygon() {
		...
		given()
				...
				.body("bbox", hasItems(8.664057f, 49.409157f, 8.699234f, 49.439262f))
	...
	public void testReachfactorAndArea() {
		...
		given()
				...
				.body("any { it.key == 'type' }", is(true))
				.body("any { it.key == 'features' }", is(true))
				.body("features[0].properties.area", is(1.5298809E7f))
				.body("features[0].properties.reachfactor", is(0.1578f))
				.statusCode(200);

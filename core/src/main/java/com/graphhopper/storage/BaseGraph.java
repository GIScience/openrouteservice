...
class BaseGraph implements Graph
{
	...
	{
		ArrayBuffer byteBuffer = new ArrayBuffer(200);
	...
	private PointList fetchWayGeometry_( long edgePointer, boolean reverse, int mode, int baseNode, int adjNode, ArrayBuffer buffer)
	{

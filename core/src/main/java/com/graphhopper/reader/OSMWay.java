...
{
    protected final TLongList nodes;// Runge = new TLongArrayList(5);
    ...
    {
        super(id, WAY);
        nodes = new TLongArrayList(5);
    }
    
    public OSMWay( long id, int nodesCount, Map<String, String> tags)
    {
        super(id, WAY, tags);
        nodes = new TLongArrayList(nodesCount);
    }

...
public class FootFlagEncoder extends AbstractFlagEncoder
{
    ...
    public long acceptWay( OSMWay way )
    {
        ...
        {
        	// Runge : forbid highways in which sidewalks are explicitly given (see http://www.openstreetmap.org/way/156480261)
        	if (way.hasTag("sidewalk", "explicit") || way.hasTag("sidewalk:both", "explicit"))
        		return 0;
        }        	
    ...
    protected void collect( OSMWay way, TreeMap<Double, Integer> weightToPrioMap )
    {
        ...
        {
        	if (maxSpeed > 0 && maxSpeed <= 30) // Runge
        	{
        		if (way.hasTag("sidewalk", "both") || way.hasTag("sidewalk", "yes"))
        			weightToPrioMap.put(40d, PREFER.getValue());
        		else
        			weightToPrioMap.put(40d, UNCHANGED.getValue());
        	}
        	else
        	{
        		...
        		else if (way.hasTag("sidewalk", "yes") || way.hasTag("sidewalk", "both")) // Runge

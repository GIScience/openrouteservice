...
public class PrepareContractionHierarchiesTest
{
    ...
    public void testShortestPathSkipNode()
    {
        ...
        double normalDist = new Dijkstra(g, carEncoder, weighting, tMode).calcPath(4, 2, -1).getDistance();
